...
!(function () {
  ...
  class M {
    constructor(t) {
      ((this.M = { S: 1, C: 5, P: NaN, k: "", T: "", R: "", D: "", V: 0, B: 0, I: 0, A: 0, O: 0 }),
        (this.L = t));
    }
    N() {
      const t = this.M,
  ...
  class S {
    ...
    X(t) {
      const i = this.K(t);
      return { Z: `rgb(${i[0]}, ${i[1]}, ${i[2]})`, G: x(i) > 160 ? "black" : "white" };
    }
    J(t) {
      return x(this.K(t));
    }
    tt(t, i, s) {
      const [n, e, r, h] = this.K(t),
        ...
        u = [
          ...
          b(r + s * (o - r)),
          ((c = h + s * (_ - h)),
          c <= 0 || c > 1 ? Math.min(Math.max(c, 0), 1) : Math.round(1e4 * c) / 1e4),
        ];
      var c;
  ...
  class D extends P {
    ...
    et({ context: t, bitmapSize: i, horizontalPixelRatio: s, verticalPixelRatio: r }) {
  ...
  function A(t, i, s, n, e, r, h = 0, a = [0, 0, 0, 0], l = "") {
    ...
    const o = h / 2;
    var _;
    (I(t, i + o, s + o, n - h, e - h, ((_ = -o), a.map((t) => (0 === t ? t : t + _)))),
      "transparent" !== r && ((t.fillStyle = r), t.fill()),
      "transparent" !== l && ((t.lineWidth = h), (t.strokeStyle = l), t.closePath(), t.stroke()),
      t.restore());
  }
      ...
      const e = this.qt.R,
        ...
        h = t.useBitmapCoordinateSpace((t) => {
          ...
          return (
            ...
            this.qt.pi && ((h.fillStyle = e), h.fillRect(l.fi, l.mi, l.wi - l.fi, l.gi)),
            this.qt.Mi &&
              ((h.fillStyle = i.D), h.fillRect(a.li ? l.bi - l.di : 0, l._i, l.di, l.xi - l._i)),
            a
          );
        });
  ...
  class L {
    constructor(t) {
      ((this.Ii = { Bi: 0, Z: "#000", Ri: 0, Ti: 0 }),
        (this.Ai = { ri: "", Et: !1, pi: !0, yi: !1, Ht: "", R: "#FFF", Mi: !1, ki: !1 }),
        (this.zi = { ri: "", Et: !1, pi: !1, yi: !0, Ht: "", R: "#FFF", Mi: !0, ki: !0 }),
        (this.St = !0),
  ...
  class F {
    ...
    nt(t, i) {
      ...
      const s = t.useMediaCoordinateSpace(
        ({ context: t }) => ((t.font = i.k), Math.round(i.Gi.Ei(t, a(this.qt).ri, W))),
      );
      if (s <= 0) return;
      const n = i.Ji,
        e = s + 2 * n,
      ...
      o < 0
        ...
        : o + e > h && ((l -= Math.abs(h - (o + e))), (o = Math.floor(l - r) + 0.5));
      const _ = o + e,
  ...
  class H {
    constructor(t, i, s) {
      ((this.St = !0),
        (this.Gt = new F()),
        (this.Zt = { Et: !1, Z: "#4c525e", R: "white", ri: "", Qi: 0, Bi: NaN, pi: !0 }),
        (this.Ct = t),
        (this.ts = i),
        (this.Yi = s));
    }
  ...
  class j extends U {
    ...
    qs(t, i, s) {
      ...
      return (
        ...
        n !== this.bs || e !== this.xs || h !== this.fs || r !== this.ds || a !== this.Pt
      );
    }
    Ls() {
      const t = this.ts
  ...
  class Y {
    ...
    Qs(t, i) {
      const s = (function (t, i) {
        return void 0 === t ? i : { tn: Math.max(t.tn, i.tn), sn: t.sn || i.sn };
      })(this.Zs.get(t), i);
      this.Zs.set(t, s);
    }
    nn() {
  ...
  class G extends K {
    ...
    xn(t) {
      ...
      if (i > 1) {
        ...
        (r >= i && ((r -= i), (s += 1)), (n = X + Z(+r.toFixed(this.Sn) * this.Mn, e)));
  ...
  class it {
    ...
    Bn(t, i, s) {
      ...
      return (
        t.restore(),
        (0 === r.width && i.length) ||
          (this.Dn.set(e, { In: r, An: this.kn }), (this.Rn[this.kn] = e), this.yn++, this.kn++),
        r
      );
    }
  }
  ...
  class dt {
    ...
    vn(t) {
      return null === t
        ? this
        : new dt(ct(Math.min, this.$e(), t.$e(), -1 / 0), ct(Math.max, this.je(), t.je(), 1 / 0));
    }
    Ye(t) {
      if (!u(t)) return;
  ...
  const gt = {
    ...
    Candlestick: (t, i, s, n) => {
      const e = i.upColor,
        ...
        c = a(t(s, n)),
        d = l(c.Ft[0]) <= l(c.Ft[3]);
      return { cr: c.R ?? (d ? e : r), dr: c.Ht ?? (d ? h : o), pr: c.vr ?? (d ? _ : u) };
    },
  ...
  class yt {
    ...
    Gr(t, i, s) {
      ...
      for (let e = t; e < i; e++) {
        ...
        Number.isNaN(t) ||
          (null === n ? (n = { Jr: t, Qr: t }) : (t < n.Jr && (n.Jr = t), t > n.Qr && (n.Qr = t)));
      }
      return n;
    }
    $r(t, i, s) {
  ...
  class Ut extends wt {
    ...
    ht(t, i) {
      (this.qt.ht(t),
        this.sh.yt("data"),
        null !== this.Sh && (i && i.zh ? this.Sh.be() : 0 === t.length && this.Sh.Me()));
    ...
    At(t) {
      if (!(
        ("Line" === this.kh || "Area" === this.kh || "Baseline" === this.kh) &&
        this.Ps.crosshairMarkerVisible
      ))
        return null;
      const i = this.qt.kr(t);
      if (null === i) return null;
      return { gt: i.Ft[3], ft: this.aa(), Ht: this.la(), Lt: this.oa(), Ot: this._a(t) };
    }
    Ie() {
  ...
  class oi {
    ...
    Oa(t, i, s) {
      ...
      if (
        (e <= n + 1e-14 && (e = n),
        (e = Math.max(1, e)),
        this.za.length > 0 && ((a = e), (l = 1), (o = 1e-14), Math.abs(a - l) < o))
      )
  ...
  class pi {
    ...
    kl(t) {
      ...
      (void 0 !== t.sn && (this.Ps.autoScale = t.sn),
        ...
        1 === t.ie && t.ie !== i.ie && ((s = hi(this.Ge, this.gl)), null !== s && this.Bl(s)));
      const n = i.ie !== this.Ps.mode;
      (n && (2 === i.ie || this.Oe()) && this.ga(),
        n && (3 === i.ie || this.El()) && this.ga(),
        void 0 !== t.Vl && i.Vl !== t.Vl && ((this.Ps.invertScale = t.Vl), this.Il()),
        this.cl.p(i, this.ie()));
    }
    Al() {
      return this.cl;
    ...
    eo(t) {
      this.Oe() ||
        ...
        (null === this.ml &&
          null === this.el &&
          (this.Ki() || ((this.ml = this.sl - t), (this.el = a(this.Qe()).Ue()))));
    }
    ro(t) {
    ...
    po() {
      ...
      if (
        (this.ja() && ((n = Math.max(n, this.Ya())), (e = Math.max(e, this.Ya()))),
        (n === this.ol && e === this._l) ||
        ...
        this.Bl(i);
      } else null === this.Ge && (this.Bl(new dt(-0.5, 0.5)), (this.gl = li(null)));
      var r, h;
    }
    jl() {
      return this.Oe() ? ti : this.El() ? si : this.Qa() ? (t) => ei(t, this.gl) : null;
    }
    vo(t, i, s) {
    ...
    co(t, i) {
      ...
      return this.mo(t, this.xl.tickmarksPriceFormatter ?? (s ? (t) => t.map(s) : void 0), i);
    }
    _o(t, i) {
    ...
    uo(t, i) {
      ...
      return this.mo(t, this.xl.tickmarksPercentageFormatter ?? (s ? (t) => t.map(s) : void 0), i);
    }
  }
  function vi(t) {
  ...
  function bi(t, i, s) {
      ...
      e = (function (t, i, s) {
        ...
        for (const a of t) {
          ...
          for (const i of t)
            ((r = i.zOrder),
              (h = n?.zOrder),
              (!h || ("top" === r && "top" !== h) || ("normal" === r && "bottom" === h)) &&
                ((n = i), (e = a)));
        }
        var r, h;
    ...
    for (const r of n) {
      if (e && e.n_ === r && "bottom" !== e.r_.zOrder && !e.r_.isBackground) return wi(e);
      if (Mi(r)) {
    ...
    w_(t, i) {
      ...
      for (let s = i; s < t.length; ++s) {
        ...
        (void 0 === n && ((n = []), this.p_.set(i.timeWeight, n)),
          n.push({ index: s, time: i.time, weight: i.timeWeight, originalTime: i.originalTime }));
      }
    }
    M_(t, i, s, n, e) {
      const r = Math.ceil(i / t);
      return (
        (null !== this.Dn && this.Dn.b_ === r && e === this.Dn.x_ && s === this.Dn.S_) ||
  ...
  class Ti {
    ...
    nu(t) {
      const i = Math.round(t.from),
        ...
        n = a(this.eu()),
        e = a(this.ru());
      return { from: a(this.ss(Math.max(n, i))), to: a(this.ss(Math.min(e, s))) };
    }
    hu(t) {
    ...
    Ea() {
      ...
      const t = this.j_,
        i =
          ((5 * (this.ts.N().layout.fontSize + 4)) / 8) * (this.Ps.tickMarkMaxCharacterLength || 8),
        s = Math.round(i / t),
        n = a(this.Pe()),
      ...
      for (const t of h) {
        ...
        (d < this.H_.length
          ...
          this.j_ > i / 2 && !_
            ...
            : (s.needAlignCoordinate = (u && t.index <= l) || (c && t.index >= o)),
          d++);
      }
    ...
    eo(t) {
      (this.wl && this.oo(),
        null === this.ml && null === this.L_ && (this.Ki() || ((this.ml = t), this.Cu())));
    }
    ro(t) {
    ...
    Mu(t) {
      ...
      return (
        void 0 === i && ((i = new xi((t) => this.Uu(t), this.o_)), this.V_.set(t.weight, i)),
        i.__(t)
      );
    }
    Uu(t) {
  ...
  class Ii {
    ...
    ac(t) {
      ...
      const i = this.qu;
      ((this.qu = t), null !== i && this.Ih(i.n_), null !== t && t.n_ !== i?.n_ && this.Ih(t.n_));
    }
    N() {
      return this.Ps;
    }
    ...
    Io(t) {
      ((this.Mo = t), this.uh.Io(this.Mo), this.$u.forEach((i) => i.Io(t)), this.pu());
    }
    dc(t) {
      1 !== this.$u.length &&
        (r(t >= 0 && t < this.$u.length, "Invalid pane index"), this.$u.splice(t, 1), this.Bh());
    }
    fc(t, i) {
    ...
    Qu(t) {
      return (
        ...
        (t = Math.min(this.$u.length, t)) < this.$u.length ? this.$u[t] : this.$c(t)
      );
    }
    Nc(t) {
  ...
  function Li(t, i, s) {
    return i
      ...
      .replace(
        /MMMM/g,
        ((t, i) =>
          new Date(t.getUTCFullYear(), t.getUTCMonth(), 1).toLocaleString(i, { month: "long" }))(
          t,
          s,
        ),
      )
      .replace(
        /MMM/g,
        ((t, i) =>
          new Date(t.getUTCFullYear(), t.getUTCMonth(), 1).toLocaleString(i, { month: "short" }))(
          t,
          s,
        ),
      )
  ...
  function Yi(t, i) {
    ...
    for (let s = ji.length - 1; s >= 0; --s)
      if (Math.floor(i.getTime() / ji[s].sd) !== Math.floor(t.getTime() / ji[s].sd))
        return ji[s].nd;
    return 0;
  }
  function Ki(t) {
  ...
  class Ji {
    ...
    key(t) {
      return "object" == typeof t && "ed" in t ? t.ed : this.key(this.convertHorzItemToInternal(t));
    }
    cacheKey(t) {
      const i = t;
      return void 0 === i.rd
  ...
  var ss = (function () {
    function t(t, i, s) {
      ...
      ((this._canvasElement = null),
        ...
        (this._allowResizeObserver =
          null === (n = null == s ? void 0 : s.allowResizeObserver) || void 0 === n || n),
    ...
    return (
      ...
      Object.defineProperty(t.prototype, "bitmapSize", {
        get: function () {
          return Qi({ width: this.canvasElement.width, height: this.canvasElement.height });
        },
        enumerable: !1,
        configurable: !0,
      }),
      ...
      (t.prototype._suggestNewBitmapSize = function (t) {
        ...
        (null === i && null === n) ||
          ...
          ((this._suggestedBitmapSize = n), this._emitSuggestedBitmapSizeChanged(i, n));
      }),
        ...
        if (null !== this._canvasElement) {
          ...
          if (null !== s) {
            var n =
                null !==
                  (i =
                    null === (t = this._devicePixelRatioObservable) || void 0 === t
                      ? void 0
                      : t.value) && void 0 !== i
                  ? i
                  : s.devicePixelRatio,
  ...
  class us {
    constructor(t, i, s) {
      ((this.ld = 0),
        (this.od = null),
        (this._d = { _t: Number.NEGATIVE_INFINITY, ut: Number.POSITIVE_INFINITY }),
        (this.ud = 0),
        (this.dd = null),
        (this.fd = { _t: Number.NEGATIVE_INFINITY, ut: Number.POSITIVE_INFINITY }),
        (this.pd = null),
        (this.vd = !1),
        (this.md = null),
        (this.wd = null),
      ...
      if (this.gd || !(r < 5)) {
        if (!this.gd) {
          const t = 0.5 * n,
            i = e >= t && !this.Ps.hf(),
            s = t > e && !this.Ps.af();
          (i || s || (this.Ed = !0), (this.gd = !0), (this.bd = !0), this.Jd(), this.qd());
        }
        if (!this.Ed) {
          const s = this.Wd(t, i);
    ...
    mf(t) {
      ...
      (this.Ud(n, this.jd.gf),
        this.dd ||
          ((this.ud = 0), (this.dd = setTimeout(this.qd.bind(this), 500)), (this.fd = fs(i))));
    }
    Mf(t) {
      if (0 !== t.button) return;
      ...
      (this.Yd(s, this.jd.bf),
        this.od ||
          ((this.ld = 0), (this.od = setTimeout(this.Xd.bind(this), 500)), (this._d = fs(t))));
    }
    Gd() {
      ...
      (ls() &&
        ...
        this.Zd.addEventListener("touchstart", this.mf.bind(this), { passive: !0 }),
        _s(this.Zd),
    ...
    Cf() {
      (void 0 === this.jd.Pf && void 0 === this.jd.yf && void 0 === this.jd.kf) ||
        (this.Zd.addEventListener("touchstart", (t) => this.Tf(t.touches), { passive: !0 }),
        this.Zd.addEventListener(
          "touchmove",
          (t) => {
            if (2 === t.touches.length && null !== this.Td && void 0 !== this.jd.yf) {
  ...
  class ms {
    ...
    Gf() {
      return Qi({ width: this.Hf.Gf().width, height: 1 * window.devicePixelRatio });
    }
    Jf(t, i, s) {
      const n = this.Gf();
    ...
    Kf() {
      ...
      ((this.Lf = new us(s, e, { hf: () => !1, af: () => !0 })), (this.Of = { tp: s, Qf: t }));
    }
    Yf() {
    ...
    ip(t) {
      null !== this.Of &&
        (this.Of.tp.style.backgroundColor = this.Ff.N().layout.panes.separatorHoverColor);
    }
    sp(t) {
    ...
    np(t) {
      ...
      const i = this.Hf.hp().Vo() + this.$f.hp().Vo(),
        ...
        n = 30 * s;
      i <= 2 * n ||
        ((this.Wf = { ap: t.pageY, lp: this.Hf.hp().Vo(), op: i - n, _p: i, up: s, cp: n }),
  ...
  class Ms {
    ...
    Cp(t, i) {
      ...
      ((this.mp = this.vp), (this.vp = this.pp), (this.pp = this.fp), (this.fp = { wt: i, dp: t }));
    }
    le(t, i) {
  ...
  class Rs {
    ...
    sv() {
      ...
      const n = this.qi.Ea();
      ((s.font = this.nv()),
        n.length > 0 && (t = Math.max(this.Np.Ei(s, n[0].Ga), this.Np.Ei(s, n[n.length - 1].Ga))));
      const e = this.ev();
      ...
      if (
        ...
        t = Math.max(
          t,
          this.Np.Ei(s, this.qi.Zi(Math.floor(Math.min(i, n)) + 0.11111111111111, r)),
          this.Np.Ei(s, this.qi.Zi(Math.ceil(Math.max(i, n)) - 0.11111111111111, r)),
        );
      }
      var h;
      s.restore();
    ...
    np(t) {
      if (null === this.qi || this.qi.Ki() || !this.Ps.handleScale.axisPressedMouseMove.price)
        return;
        ...
        t.useBitmapCoordinateSpace(
          ({ context: t, horizontalPixelRatio: r, verticalPixelRatio: h }) => {
            ...
            const a = Math.max(1, Math.floor(h)),
              ...
              o = Math.round(n.C * r);
            t.beginPath();
            for (const s of i) t.rect(Math.floor(e * r), Math.round(s.ya * h) - l, o, a);
            t.fill();
          },
        ),
        t.useMediaCoordinateSpace(({ context: t }) => {
    ...
    vv(t, i, s) {
      ...
      for (const s of t) {
        const t = Math.floor(s.$t(i) / 2),
          n = s.Bi();
        (n > -t && n < t && s.Fi(t),
          n > this.Op.height - t && n < this.Op.height + t && s.Fi(this.Op.height - t));
      }
  ...
  class Is {
    ...
    zv(t) {
      (null !== this.Dv && this.Dv.t_().u(this),
        (this.Dv = t),
        null !== this.Dv && this.Dv.t_().i(Is.prototype.Ev.bind(this), this, !0),
        this.Av(),
    ...
    gf(t) {
      ...
      null !== this.yv &&
        i.Et() &&
        ((this.Tv = { x: i.si(), y: i.ni() }), (this.yv = { x: t.localX, y: t.localY }));
    }
    lf(t) {
    ...
    Gv(t, i) {
      a("left" === i ? this.mv : this.wv).rv(Qi({ width: t, height: this.Op.height }));
    }
    Zf() {
      return this.Op;
    }
    ...
    av(t) {
      ...
      if (1 !== t) {
        ...
        null !== t &&
          ...
          this.Dv && (this.Qv(t, Ds), this.tm(t), this.Qv(t, Es), this.Qv(t, Vs)));
      }
      this.Gp.applySuggestedBitmapSize();
      const s = rs(this.Gp, i);
      null !== s &&
    ...
    Ov() {
      ...
      (i || null === this.mv || (this.Bv.removeChild(this.mv.Xf()), this.mv.m(), (this.mv = null)),
        s ||
          null === this.wv ||
      ...
      (i &&
        null === this.mv &&
        ((this.mv = new Rs(this, t.N(), n, "left")), this.Bv.appendChild(this.mv.Xf())),
        s &&
          null === this.wv &&
          ((this.wv = new Rs(this, t.N(), n, "right")), this.Iv.appendChild(this.wv.Xf())));
    }
    hm(t) {
    ...
    $v(t) {
      ...
      const n = this.Dp.N(),
        e = n.handleScroll,
        r = n.kineticScroll;
      if ((!e.pressedMouseMove || t.Bf) && ((!e.horzTouchDrag && !e.vertTouchDrag) || !t.Bf))
        return;
      const h = this.Dv.ks(),
        a = performance.now();
      if (
        (null !== this.Mv ||
          this.hm(t) ||
          (this.Mv = { x: t.clientX, y: t.clientY, ed: a, om: t.localX, _m: t.localY }),
        null !== this.Mv && !this.bv && (this.Mv.x !== t.clientX || this.Mv.y !== t.clientY))
      ) {
        if ((t.Bf && r.touch) || (!t.Bf && r.mouse)) {
          const t = s.vu();
          ((this.Rv = new Ms(0.2 / t, 7 / t, 0.997, 15 / t)), this.Rv.Cp(s.wu(), this.Mv.ed));
        } else this.Rv = null;
  ...
  class As {
    ...
    _v({ context: t, bitmapSize: i, horizontalPixelRatio: s, verticalPixelRatio: n }) {
      if (!this.um()) return;
  ...
  class Ws {
    ...
    xf() {
      ...
      !t.It().Ki() &&
        this.vm &&
        ((this.vm = !1), this.Dp.N().handleScale.axisPressedMouseMove.time && t.yc());
    }
    uf(t) {
      const i = this.Dp.Qt();
    ...
    cv(t) {
      ...
      (r.borderVisible &&
        ...
        t.useMediaCoordinateSpace(({ context: t }) => {
          ...
          for (const e of s)
            if (e.weight < n) {
              const s = e.needAlignCoordinate ? this.Bm(t, e.coord, e.label) : e.coord;
    ...
    xm() {
      ...
      (i.leftPriceScale.visible &&
        null === this.fm &&
        ((this.fm = new As("left", i, s, n, e)), this.gm.appendChild(this.fm.Xf())),
        i.rightPriceScale.visible &&
          null === this.pm &&
          ((this.pm = new As("right", i, s, n, e)), this.Mm.appendChild(this.pm.Xf())));
    }
  }
  const Fs =
    !!hs &&
  ...
  class Hs {
    ...
    m() {
      (this.Ym(!1),
        ...
        this.ts.Eo().u(this),
        this.ts.m());
      for (const t of this.Am) (this.$m.removeChild(t.Xf()), t.Kv().u(this), t.Xv().u(this), t.m());
      this.Am = [];
      for (const t of this.zm) this.iw(t);
      ((this.zm = []),
        a(this.Xm).m(),
        null !== this.yp.parentElement && this.yp.parentElement.removeChild(this.yp),
        this.Ku.m(),
        this.xv.m(),
        this.Sv.m(),
        this.sw());
    ...
    hr(t) {
      ...
      this.ts.hr(t);
      const s = Us(this.Ps);
      (s !== i && this.Ym(s), t.layout?.panes && this.ew(), this.Qm(), this.rw(t));
    }
    Kv() {
      return this.xv;
    }
    ...
    rw(t) {
      (void 0 !== t.autoSize || !this.Hm || (void 0 === t.width && void 0 === t.height)) &&
    ...
    aw(t) {
        ...
        e = (i, s) => {
          ...
          for (let e = 0; e < this.Am.length; e++) {
            const r = this.Am[e],
              ...
              l = h.Gf();
            if ((null !== t && h.Jf(t, s, n), (n += l.height), e < this.Am.length - 1)) {
              const i = this.zm[e],
                r = i.Gf();
      ...
      for (let n = 0; n < this.Am.length; n++) {
        const e = this.Am[n],
          r = e.Gf();
        if ((null !== t && e.Jf(t, i, s), (s += r.height), n < this.Am.length - 1)) {
          const e = this.zm[n],
            r = e.Gf();
    ...
    pw() {
      ...
      for (const n of this.Am)
        (this.ow() && (i = Math.max(i, a(n.sm()).sv(), this.Ps.leftPriceScale.minimumWidth)),
          this._w() && (s = Math.max(s, a(n.nm()).sv(), this.Ps.rightPriceScale.minimumWidth)),
          (t += n.Vo()));
      ((i = os(i)), (s = os(s)));
      const n = this.Mo,
        e = this.sl,
      ...
      for (let t = 0; t < this.Am.length; ++t) {
        ...
        let e = 0,
          h = 0;
        ((h =
          t === this.Am.length - 1 ? Math.ceil((c - f) * p) / p : Math.round(n.Vo() * d * p) / p),
          (e = Math.max(h, 2)),
          (f += e),
  ...
  class hn {
    ...
    Ww(t, i) {
      ...
      if (n) {
        const t = [];
        (this.zw.forEach((i) => {
          t.push({ timeWeight: 0, time: i.Hh, pointData: i, originalTime: rn(i.Bw) });
        }),
      ...
      return this.$w(
        ...
        (function (t, i, s) {
          const n = en(t, s),
            e = en(i, s);
          if (void 0 !== n && void 0 !== e) return { jw: !1, zh: n.Aw >= e.Aw && n.Iw >= e.Iw };
    ...
    qw(t, i, s) {
      ...
      if (!s && void 0 !== r && this.o_.key(e) < this.o_.key(r))
        throw new Error(`Cannot update oldest data, last time=${r}, new time=${e}`);
      ...
      const d = { timeWeight: 0, time: h.Hh, pointData: h, originalTime: rn(h.Bw) },
    ...
    Fw() {
      for (const t of this.Nw) 0 === t.pointData.Bw.size && this.zw.delete(this.o_.key(t.time));
    }
    Uw(t) {
      let i = -1;
      ...
      if (
        (-1 === i && this.Nw.length !== t.length && (i = Math.min(this.Nw.length, t.length)),
        -1 === i)
      )
        return -1;
  ...
  class dn extends un {
    ...
    cg() {
      this.sh.update(
        { bars: this.sg.map(fn), barSpacing: this.Qn.It().vu(), visibleRange: this.ng },
        this.Jn.N(),
      );
    }
  }
  ...
  function bn(t) {
    const i = { open: t.Ft[0], high: t.Ft[1], low: t.Ft[2], close: t.Ft[3], time: t.Pw };
    return (void 0 !== t.Vw && (i.customValues = t.Vw), i);
  }
  function xn(t) {
    const i = bn(t);
  ...
  function En() {
    return {
      ...
      timeScale: Dn,
      localization: { locale: hs ? navigator.language : "", dateFormat: "dd MMM 'yy" },
  ...
  class Bn {
    ...
    moveTo(t) {
      ...
      i !== t &&
        (r(t >= 0 && t < this.Ff.Uf().length, "Invalid pane index"), this.Ff.Qt().mc(i, t));
    }
    getSeries() {
    ...
    attachPrimitive(t) {
      (this.Pt.ua(t),
        t.attached && t.attached({ chart: this.wg, requestUpdate: () => this.Pt.Qt().Bh() }));
    }
    detachPrimitive(t) {
      this.Pt.ca(t);
    }
      ...
      (function (t) {
        if (f(t.handleScale)) {
          ...
          (f(i) && (t.handleScale.axisPressedMouseMove = { time: i, price: i }),
            f(s) && (t.handleScale.axisDoubleClickReset = { time: s, price: s }));
        }
  ...
  class Wn {
    ...
    $g(t) {
      let i = this.$u.get(t);
      return (i || ((i = new Bn(this.Ff, (t) => this.jg(t), t, this)), this.$u.set(t, i)), i);
    }
  }
  function Fn(t) {
    if (d(t)) {
  ...
  function Kn(t, i, s) {
    ...
    var r, h;
    return [
      ((r = t[i]), (h = Yn(qn(t[s], t[n]), jn)), { _t: r._t + h._t, ut: r.ut + h.ut }),
  ...
  class ie {
    ...
    sM(t) {
      if (this.Ps.localization?.timeFormatter) return this.Ps.localization.timeFormatter(t);
      if (t < 12) return `${t}M`;
        ...
        r !== s &&
          ...
          i.setData(
            (function ({ le: t, oe: i, nM: s }) {
              return Array.from({ length: Math.floor((i - t) / s) + 1 }, (i, n) => ({
                time: t + n * s,
              }));
            })(e),
          ));
  ...
  const Me = {
    type: "Bar",
    isBuiltIn: !0,
    defaultOptions: { upColor: "#26a69a", downColor: "#ef5350", openVisible: !0, thinBars: !0 },
    Wg: (t, i) => new ge(t, i),
  };
  class be extends P {
    constructor() {
    ...
    _v(t, i, s) {
      ...
      for (let t = s.from; t < s.to; t++) {
        ...
        if (
          (null !== l && ((o = Math.max(l + 1, o)), (o = Math.min(o, _))), this.qt.vu * e > 2 * a)
        )
  ...
  class Ce extends P {
    ...
    et({ context: t, horizontalPixelRatio: i, verticalPixelRatio: s }) {
      ...
      for (let i = this.qt.lt.from; i < this.qt.lt.to; i++) {
        ...
        let o, _;
        ((t.fillStyle = h.cr),
          l <= e ? ((o = l), (_ = r)) : ((o = e), (_ = l - Math.floor(n / 2) + n)),
    ...
    BM(t) {
      ...
      for (let i = this.qt.lt.from; i < this.qt.lt.to; i++) {
        ...
        this.VM[i - this.qt.lt.from] = { Uh: r, bi: h, AM: e, ne: n._t * t, wt: n.wt };
      }
  ...
  const Te = { visible: !0, horzAlign: "center", vertAlign: "center", lines: [] },
    Re = { color: "rgba(0, 0, 0, 0.5)", fontSize: 48, fontFamily: w, fontStyle: "", text: "" };
  class De {
    constructor(t) {
    ...
    draw(t) {
      t.useMediaCoordinateSpace((t) => {
        ...
        for (const t of this.qt.lines) {
          ...
          (e > s.width ? (t.Su = s.width / e) : (t.Su = 1), (n += t.lineHeight * t.Su));
        }
        let e = 0;
  ...
  class Le {
    ...
    draw(t) {
      t.useMediaCoordinateSpace((t) => {
        ...
        s &&
          this.qt.jM &&
          ((i.globalAlpha = this.qt.alpha ?? 1), i.drawImage(this.qt.jM, s._t, s.ut, s.Qi, s.$t));
      });
    }
    $M(t, i) {
    ...
    attached(t) {
      ...
      ((this.eb = i),
        ...
        (this.sb.onload = () => {
          ...
          (this.HM.forEach((s) => s.GM({ QM: t, JM: i, tb: this.sb })), this.eb && this.eb());
        }),
        (this.sb.src = this.nb));
    }
    detached() {
  ...
  function Ge(t, i, s, n, e, r) {
    const h = (qe("arrowUp", n) - 1) / 2,
      a = (Xt(n / 2) - 1) / 2;
    if (e >= i - a - 2 && e <= i + a + 2 && r >= (t ? s : s - h) - 2 && r <= (t ? s + h : s) + 2)
      return !0;
    return (() => {
      if (e < i - h - 3 || e > i + h + 3 || r < (t ? s - h - 3 : s) || r > (t ? s : s + h + 3))
        return !1;
  ...
  class Je {
    ...
    Yn(t, i) {
      ...
      for (let s = this.qt.lt.from; s < this.qt.lt.to; s++) {
        ...
        if (n && tr(n, t, i)) return { zOrder: "normal", externalId: n.Kn ?? "" };
      }
      return null;
    }
    draw(t) {
    ...
    switch (i.position) {
      ...
      case "atPriceTop": {
        ...
        return (
          ...
          void 0 !== t.ri && ((t.ri.ut = t.ut - p - 0.6 * e), (n._b += 1.2 * e)),
          void (_ || (n._b += f + r))
        );
      }
      case "belowBar":
      case "atPriceBottom": {
        ...
        return (
          (t.ut = a(h.priceToCoordinate(o)) + p + i),
          void 0 !== t.ri && ((t.ri.ut = t.ut + p + r + 0.6 * e), (n.ub += 1.2 * e)),
          void (_ || (n.ub += f + r))
        );
      }
    }
  ...
  class rr {
      ...
      if (this.xb || t !== this.Pb) {
        if (((this.Pb = t), this.cb.length > 0)) {
          const i = Ke(t),
            s = 1.5 * Ye(t) + 2 * i,
            n = this.Eb();
          this.Sb = { above: Xe(s, n.aboveBar, n.inBar), below: Xe(s, n.belowBar, n.inBar) };
        } else this.Sb = null;
        this.xb = !1;
      }
      return this.Sb;
    ...
    Eb() {
      return (
        null === this.Cb &&
          (this.Cb = this.cb.reduce((t, i) => (t[i.position] || (t[i.position] = !0), t), {
            inBar: !1,
            aboveBar: !1,
            belowBar: !1,
            atPriceTop: !1,
  ...
  class ar {
    ...
    Nb() {
      ...
      for (const [s, n] of this.cb)
        !n.Ob || n.Ob > t ? i.push({ time: n.time, sign: n.sign, value: n.value }) : this.Ib(s);
      return i;
    }
    Wb(t) {
      this.Vb = t;
  ...
  const lr = { positiveColor: "#22AB94", negativeColor: "#F7525F", updateVisibilityDuration: 5e3 };
  class or {
    constructor(t, i, s, n) {
